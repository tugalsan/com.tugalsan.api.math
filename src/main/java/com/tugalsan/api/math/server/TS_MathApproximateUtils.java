...
public class TS_MathApproximateUtils {
    ...
    final private static TS_Log d = TS_Log.of( TS_MathApproximateUtils.class.getSimpleName());
    ...
    public static void testApprox() {
        ...
        d.ce("test", "TS_MathApproximateUtils.known_input_values", TGS_StringUtils.toString(known_input_values, ", "));
        d.ce("test", "TS_MathApproximateUtils.known_output_values", TGS_StringUtils.toString(known_output_values, ", "));
        d.ce("test", "TS_MathApproximateUtils.req ", TGS_StringUtils.toString(request_input_values, ", "));
        d.ce("test", "TS_MathApproximateUtils.calc", TGS_StringUtils.toString(calc, ", "));
    }
