...
public class TS_MathArrayVectorFunc_OutTyped_In2Utils {
    ...
    public static void bytes(TS_MathArrayVectorTypes vectorType,
            ...
            TGS_FuncMTUCE_OutTyped_In2<ByteVector, ByteVector, ByteVector> exeVector,
            TGS_FuncMTUCE_OutTyped_In2<Byte, Byte, Byte> exeScalar) {
        switch (vectorType) {
    ...
    public static void shorts(TS_MathArrayVectorTypes vectorType,
            ...
            TGS_FuncMTUCE_OutTyped_In2<ShortVector, ShortVector, ShortVector> exeVector,
            TGS_FuncMTUCE_OutTyped_In2<Short, Short, Short> exeScalar) {
        switch (vectorType) {
            case TS_MathArrayVectorTypes._0064, TS_MathArrayVectorTypes._0128, TS_MathArrayVectorTypes._0256, TS_MathArrayVectorTypes._0512, TS_MathArrayVectorTypes._MAX, TS_MathArrayVectorTypes._PREFERRED ->
    ...
    public static void integers(TS_MathArrayVectorTypes vectorType,
            ...
            TGS_FuncMTUCE_OutTyped_In2<IntVector, IntVector, IntVector> exeVector,
            TGS_FuncMTUCE_OutTyped_In2<Integer, Integer, Integer> exeScalar) {
        switch (vectorType) {
            case TS_MathArrayVectorTypes._0064, TS_MathArrayVectorTypes._0128, TS_MathArrayVectorTypes._0256, TS_MathArrayVectorTypes._0512, TS_MathArrayVectorTypes._MAX, TS_MathArrayVectorTypes._PREFERRED ->
    ...
    public static void longs(TS_MathArrayVectorTypes vectorType,
            ...
            TGS_FuncMTUCE_OutTyped_In2<LongVector, LongVector, LongVector> exeVector,
            TGS_FuncMTUCE_OutTyped_In2<Long, Long, Long> exeScalar) {
        switch (vectorType) {
            case TS_MathArrayVectorTypes._0064, TS_MathArrayVectorTypes._0128, TS_MathArrayVectorTypes._0256, TS_MathArrayVectorTypes._0512, TS_MathArrayVectorTypes._MAX, TS_MathArrayVectorTypes._PREFERRED ->
    ...
    public static void floats(TS_MathArrayVectorTypes vectorType,
            ...
            TGS_FuncMTUCE_OutTyped_In2<FloatVector, FloatVector, FloatVector> exeVector,
            TGS_FuncMTUCE_OutTyped_In2<Float, Float, Float> exeScalar) {
        switch (vectorType) {
            case TS_MathArrayVectorTypes._0064, TS_MathArrayVectorTypes._0128, TS_MathArrayVectorTypes._0256, TS_MathArrayVectorTypes._0512, TS_MathArrayVectorTypes._MAX, TS_MathArrayVectorTypes._PREFERRED ->
    ...
    public static void doubles(TS_MathArrayVectorTypes vectorType,
            ...
            TGS_FuncMTUCE_OutTyped_In2<DoubleVector, DoubleVector, DoubleVector> exeVector,
            TGS_FuncMTUCE_OutTyped_In2<Double, Double, Double> exeScalar) {
        switch (vectorType) {
            case TS_MathArrayVectorTypes._0064, TS_MathArrayVectorTypes._0128, TS_MathArrayVectorTypes._0256, TS_MathArrayVectorTypes._0512, TS_MathArrayVectorTypes._MAX, TS_MathArrayVectorTypes._PREFERRED ->
